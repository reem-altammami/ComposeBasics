package com.reem.composebasics
...
import com.reem.composebasics.ui.theme.ComposeBasicsTheme
...
fun MyApp() {
    ...
    if (shouldShowOnboarding) {
        OnbiardingScreen(onContinueClicked = { shouldShowOnboarding = false })
    } else {
        Greetings()
    }
...
@Composable
fun OnbiardingScreen(onContinueClicked: () -> Unit) {
    Surface() {
        Column(
...
fun OnboardingPreview() {
    ComposeBasicsTheme {
        OnbiardingScreen (onContinueClicked = {})
    }
}